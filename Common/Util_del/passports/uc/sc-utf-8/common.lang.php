<?php
return array(
'toseller_store_closed_notify' => '您的地区加盟商已被关闭，原因是：{$reason}',
    'toseller_store_opened_notify' => '您的地区加盟商已开通',
    'toseller_store_expired_closed_notify' => '您的地区加盟商已被关闭，原因是：地区加盟商已到期',
    ...
    'toseller_store_droped_notify' => '您的地区加盟商已被删除',
    'toseller_store_passed_notify' => '恭喜，您的地区加盟商已开通，赶快来用户中心发布商品吧。',
    'toseller_store_refused_notify'=> '抱歉，您的加盟申请已被拒绝，原因如下： {$reason}',

    'code_example' => "字体加粗：[b]加粗[/b]<br />图片标签：[img]http://zhaimao.daogoge.cn/images/logo.gif[/img]<br/>超链接标签：[url=http://zhaimao.daogoge.cn]Boot官方网站[/url]<br/>引用标签：[quote]Boot[/quote]<br />代码标签：[code]array('2222','3333')[/code]",
);
?>
