...
return array (
  'version' => '1.0',
  'subject' => '{$site_name}提醒:地区加盟商{$order.seller_name}已确认收到了您线下支付的货款',
  'content' => '<p>尊敬的{$order.buyer_name}:</p>
<p style="padding-left: 30px;">与您交易的地区加盟商{$order.seller_name}已经确认了收到了您的订单{$order.order_sn}的付款，请耐心等待卖家发货。</p>
