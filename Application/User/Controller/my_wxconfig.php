...
class My_wxconfigApp extends MemberBaseApp {
    ...
    function index() {
        ...
        if (!IS_POST) {
            $wx_config = $this->my_wxconfig_mod->get_info_user($user_id);
            ...
            $wx_config['url'] = SITE_URL . '/index.php?app=weixin&id=' . $user_id;
            ...
            $w_id = $this->my_wxconfig_mod->unique($user_id);
            if ($w_id) {
