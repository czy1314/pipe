...
class SessionProcessor
{
     ...
     * @return void
     */
    function SessionProcessor(&$db, $session_table, $session_data_table, $session_name = 'PIPE_ID', $session_id = '')
    {
    ...
    function _sess_write($sesskey, $sessvalue)
    {
        ...
        {
            $this->db->query("REPLACE INTO `pipe_sessions_data` SET sesskey = '{$this->session_id}', expiry={$expiry}, data='{$sessvalue}'");
            $is_overflow = 1;
            $sessvalue = '';
        }
